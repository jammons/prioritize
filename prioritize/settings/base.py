...
WSGI_APPLICATION = 'prioritize.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[prioritize]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_prioritize"  # Make this unique to your project.
