"""
Starter fabfile for deploying the prioritize project.
...
# CHANGEME
env.hosts = ['user@prioritize.example.com']
env.code_dir = '/srv/www/prioritize'
env.project_dir = '/srv/www/prioritize/prioritize'
env.static_root = '/srv/www/prioritize/static/'
env.virtualenv = '/srv/www/prioritize/.virtualenv'
env.code_repo = 'git@github.com:user/prioritize.git'
env.django_settings_module = 'prioritize.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/prioritize/wsgi.py" % env.code_dir)
